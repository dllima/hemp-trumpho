...
// Verso da carta: usa a arte real do baralho (costas.webp). Se o asset não
// carregar, cai no verso desenhado em CSS (fundo verde radial, meio-tom, raios
  ...
  return (
    ...
    >
      {semCostas ? (
        ...
        <img
          src="/cartas/bg/costas.webp"
          alt="Verso da carta"
          className="absolute inset-0 w-full h-full object-cover"
          onError={() => setSemCostas(true)}
        />
      )}
